...
update agreements set current_version_id = '0b000000-0000-0000-0000-000000000001'
...
insert into agreement_participants (agreement_id, user_id, role_in_agreement, consent_state, signed_at) values
  ('0a000000-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111','proposer','accepted', now()),
  ('0a000000-0000-0000-0000-000000000001','22222222-2222-2222-2222-222222222222','signer','accepted', now());
...
insert into signals (family_id, subject_user_id, category, type, value, value_type, unit, window_start, window_end, confidence, source_type, transform_id, transform_version, privacy_class, domain, raw_exclusion_note) values
  ('fa000000-0000-0000-0000-000000000001','22222222-2222-2222-2222-222222222222','attention_engagement','late-night-activity',22,'scalar','%', now() - interval '7 days', now(), 0.9,'instagram_export','late-night-activity.v1','1.0.0','derived_safe','wellness','derived; raw destroyed'),
