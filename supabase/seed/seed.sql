...
insert into signals (family_id, subject_user_id, category, type, value, value_type, unit, window_start, window_end, confidence, source_type, transform_id, transform_version, privacy_class, domain, raw_exclusion_note) values
  ('fa000000-0000-0000-0000-000000000001','22222222-2222-2222-2222-222222222222','attention_engagement','late_night_usage',45,'scalar','minutes', now() - interval '7 days', now(), 0.9,'instagram_export','late_night_usage.v1','1.0.0','derived_safe','wellness','derived; raw destroyed'),
  ('fa000000-0000-0000-0000-000000000001','22222222-2222-2222-2222-222222222222','content_exposure','content_volume',12,'scalar','sessions', now() - interval '7 days', now(), 0.8,'instagram_export','content_volume.v1','1.0.0','derived_safe','social','count only');
